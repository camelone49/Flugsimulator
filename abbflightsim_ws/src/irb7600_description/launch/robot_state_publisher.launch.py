...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        '/abbflightsim_ws/src/irb7600_moveit_config/config'
    )
    install_config_path = os.path.join(
        '/abbflightsim_ws/install/irb7600_moveit_config/share/irb7600_moveit_config/config'
    )
    ...
    for config_path in [src_config_path, install_config_path]:
        ...
        output_path = os.path.join(config_path, 'ros2_controllers_template.yaml')
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='abb_irb7600_150_350',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'irb7600_description'
    urdf_filename = 'irb7600_150_350.urdf.xacro'
    rviz_config_filename = 'irb7600_view.rviz'
